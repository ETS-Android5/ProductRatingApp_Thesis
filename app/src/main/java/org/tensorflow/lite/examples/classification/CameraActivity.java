...
import static org.tensorflow.lite.examples.classification.AppData.rProducts;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  final List<RecommendedList> recommendedLists= new ArrayList<>();
  DatabaseHelper databaseHelper = new DatabaseHelper(this);
  private ProgressDialog mProgressDialog;
  public String uID;
  final List<Product> allproducts= new ArrayList<>();
  public List<RecommendedList> filteredRProducts = new ArrayList<>();
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    dialogBtn = findViewById(R.id.dialog_button);
...
//    });
  ...
  private void fetchData() {
    ...
    databaseReference.addValueEventListener(new ValueEventListener() {
      ...
      public void onDataChange(@NonNull DataSnapshot snapshot)
      {
        ...
        {
          RecommendedList recommendedList = dataSnapshot.getValue(RecommendedList.class);
          recommendedLists.add(recommendedList);

        }
        rProducts = recommendedLists;
  ...
  public void showDialog(Activity activity){
    ...
    {
      if(rProducts.get(i).getCategoryId() == currentProduct.getCategoryId() && rProducts.get(i).getProductId() != currentProduct.getProductId())
      {
        filteredRProducts.add(rProducts.get(i));
      }
    }
    Log.d("CameraActivity","Filtered Rproducts"+currentProduct.getCategoryId());

    RecyclerView recyclerView = dialog.findViewById(R.id.recycler);
    AdapterRe adapterRe = new AdapterRe(activity, filteredRProducts);
...
/*  public void ShowPopup(View v) {
    ...
    txtclose.setText("M");
    RecommendedList[] myListData = new RecommendedList[]{
    new RecommendedList("Email",101, categoryId)} ;

    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerview_product_list);
    RecommenedListAdapter adapter = new RecommenedListAdapter(myListData);
